...
#define STORYTELLER_FAVOR_HARD_ANTAGS (STORYTELLER_FAVOR_WEREWOLF | STORYTELLER_FAVOR_MASQUERADE) // OV Edit: Removed VLord, Lich, and Bandit
#define STORYTELLER_ALL_ANTAGS (STORYTELLER_FAVOR_GNOLL | STORYTELLER_FAVOR_ASSASSIN | STORYTELLER_FAVOR_WEREWOLF | STORYTELLER_FAVOR_MASQUERADE | STORYTELLER_FAVOR_DARK_ITINERANT) // OV Edit: Removed VLord, Lich, Bandit, and Dreamwalker
